...
import com.lucky_andaman.backend.dto.RoomDTO;
...
import com.lucky_andaman.backend.service.AwsS3Service;
...
public class RoomService implements IRoomService {
    ...
    public Response deleteRoom(Long roomId) {
        ...
        try {
            roomRepository.findById(roomId).orElseThrow(() -> new RunException("Room Not Found"));
